...
// не нужен C from n by k по той причине, что это не эффективно
// далее, мы уменьшаем асимптотику
// в GUI добавить кнопку гереации рандомного графа, в котором будет некотрая вероятность наличия рёбер между вершинами...
// команды надо выделять цветом, не перестривая (фактичекси) граф. Ну, и немного пооптимизировать в случае всеобщего знакомстава